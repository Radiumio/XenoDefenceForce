...
class CfgVehicles
{
	...
	class XDF_Nemesis: Helicopter_Base_H
	{
		author="Radium";
		scope=2;
		...
		class Turrets: Turrets										/// just a copilot seat as a turret to enable taking the controls
		{
			class CopilotTurret: CopilotTurret						/// taking controls is already defined in parent class
			{
				body = "mainTurret";
				gun = "weaponry";
				gunnerAction = Pilot_Plane_Fighter_01;				/// what action does copilot switch to
				gunnerInAction = Pilot_Plane_Fighter_01;				/// what action does copilot switch to
				...
				memoryPointsGetInCargo = "pos gunner";				/// what is the position of get in action
				memoryPointsGetInCargoDir = "pos gunner dir";		/// what is the direction of get in action
				canEject = 0;										/// copilot shouldn't be able to do so as he doesn't have eject seat
				minElev = 0; 										/// what is the lowest possible elevation of the turret
				maxElev = +10;  									/// what is the highest possible elevation of the turret
				initElev = 0; 										/// what is the starting elevation of the turret
				minTurn = 360;  									/// what is the right-most possible turn of the turret
				maxTurn = 360;  									/// what is the left-most possible turn of the turret
