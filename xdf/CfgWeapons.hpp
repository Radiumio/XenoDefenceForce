...
class cfgWeapons
{
	...
	class U_XDF_Marine_Uniform: EF_U_B_MarineCombatUniform_Des_5
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\xdf\retextures\xdf_uniform\uniforms\U_XDF_Marines_co.paa"
		};
		class ItemInfo: UniformItem
		{
			uniformModel="-";
	...
	class V_XDF_AAV: EF_V_AAV_Black
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\xdf\retextures\xdf_uniform\vests\V_XDF_AA_vest_co.paa"
		};
	};
	...
	class V_XDF_AAV_Medic: EF_V_AAV_Scout_Black
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\xdf\retextures\xdf_uniform\vests\V_XDF_AA_med_vest_co.paa",
			"\a3\weapons_f_epb\Rifles\MX_Black\Data\XMX_Base_Black_co.paa"
		};
	};
