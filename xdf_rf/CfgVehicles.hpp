class CfgVehicles
{
	...
	class XDF_Mamba: B_Heli_EC_03_RF
	{
		author="Radium";
		scope = 2;
		scopeCurator = 2;
	...
	class XDF_Mamba_Unarmed: B_Heli_EC_04_military_RF
	{
		author="Radium";
		scope = 2;
		scopeCurator = 2;
	...
	class XDF_Mamba_SOCAT: I_Heli_EC_02_RF
	{
		author="Radium";
		scope = 2;
		scopeCurator = 2;
	...
	class XDF_TwinMortar: B_TwinMortar_RF
	{
		author="Radium";
		scope = 2;
		scopeCurator = 2;
	...
	class B_XDF_Scout_F : TCGM_RollUp_B_MTP_Soldier_LT
	{
		author = "Radium";
		scope = 2;
		scopeCurator = 2;
